...
const translations = {
  it: {
    ...
    'settings.delete_scan_history': 'Elimina Cronologia Analisi',
    ...
    'consent.body': "La tua foto del viso è un dato biometrico — per questo chiediamo il tuo permesso prima di continuare.\n\n• La foto viene inviata per l'analisi tramite intelligenza artificiale (Google Gemini) solo al momento della scansione.\n• Non viene memorizzata su alcun server — viene analizzata e scartata immediatamente.\n• Solo i risultati (punteggi di idratazione, untuosità, ecc.) vengono salvati nel tuo profilo, per monitorare i tuoi progressi.\n• Puoi eliminare questa cronologia o revocare questo consenso in qualsiasi momento, nelle Impostazioni.\n\nQuesta analisi è generata dall'IA e ha scopo puramente informativo e di autocura — non sostituisce una consulenza, diagnosi o trattamento dermatologico professionale.",
    'consent.accept': 'Ho capito e accetto',
    'consent.decline': 'Non ora',
    'consent.locked_message': "Hai rifiutato il consenso per l'analisi facciale con IA. Tocca per rivedere e accettare.",
    ...
    'paywall.topup_plan': 'Pacchetto Singolo',
    'paywall.topup_badge': 'PAGAMENTO UNICO',
    'paywall.topup_desc': '+2 analisi facciali · +3 ricerche ingredienti',
    'paywall.topup_btn': 'Acquista Pacchetto',
    'paywall.monthly_plan': 'Premium Mensile',
    'paywall.monthly_badge': 'PIÙ POPOLARE',
    'paywall.monthly_desc': 'Tutte le funzioni illimitate per 30 giorni',
    'paywall.monthly_btn': 'Abbonati al Premium',
    'paywall.monthly': '{price} / mese',
    'paywall.feat_unlimited': 'Routine e Prodotti illimitati',
    'paywall.feat_ai': 'Analisi Facciale IA — illimitata',
    'paywall.feat_journal': 'Diario della pelle e monitoraggio fotografico',
    'paywall.feat_scan': 'Leitor Facciale IA esclusivo',
    'paywall.trial': 'Abbonati al Premium',
    ...
    'paywall.purchase_topup_title': 'Pacchetto Attivato!',
    'paywall.purchase_topup_msg': 'I tuoi crediti sono stati aggiunti. Buona analisi!',
    ...
    'scan.limit_reached': 'Nessun credito disponibile. Acquista un pacchetto o abbonati.',
    'scan.premium_only': 'Funzionalità Premium',
    'scan.remaining': 'Analisi rimanenti questo mese: {n}',
    'scan.welcome_gift': '1 analisi gratuita disponibile',
    'scan.topup_remaining': '{n} analisi disponibili',
    'scan.get_more': 'Ottieni più analisi',
    'scan.start': 'Inizia Scansione',
  ...
  en: {
    ...
    'settings.delete_scan_history': 'Delete Scan History',
    ...
    'consent.body': "Your face photo is biometric data — that's why we ask for your permission before continuing.\n\n• The photo is sent for analysis by an AI service (Google Gemini) only at the moment of the scan.\n• It is not stored on any server — it is analyzed and discarded immediately.\n• Only the results (hydration, oiliness scores, etc.) are saved to your profile, so you can track your progress.\n• You can delete this history or revoke this consent at any time in Settings.\n\nThis analysis is generated by AI and is purely informational and for self-care purposes — it does not replace professional dermatological advice, diagnosis, or treatment.",
    'consent.accept': 'I understand and accept',
    'consent.decline': 'Not now',
    'consent.locked_message': 'You declined consent for AI facial analysis. Tap to review and accept.',
    ...
    'paywall.topup_plan': 'One-Time Pack',
    'paywall.topup_badge': 'ONE-TIME',
    'paywall.topup_desc': '+2 facial scans · +3 ingredient searches',
    'paywall.topup_btn': 'Buy Pack',
    'paywall.monthly_plan': 'Monthly Premium',
    'paywall.monthly_badge': 'MOST POPULAR',
    'paywall.monthly_desc': 'All features unlimited for 30 days',
    'paywall.monthly_btn': 'Subscribe to Premium',
    'paywall.monthly': '{price} / month',
    'paywall.feat_unlimited': 'Unlimited routines and products',
    'paywall.feat_ai': 'AI Facial Analysis — unlimited',
    'paywall.feat_journal': 'Skin journal and photo progress tracking',
    'paywall.feat_scan': 'Exclusive AI Facial Reader',
    'paywall.trial': 'Subscribe to Premium',
    ...
    'paywall.purchase_topup_title': 'Pack Activated!',
    'paywall.purchase_topup_msg': 'Your credits have been added. Happy scanning!',
    ...
    'scan.limit_reached': 'No credits available. Buy a pack or subscribe.',
    'scan.premium_only': 'Premium Feature',
    'scan.remaining': 'Scans remaining this month: {n}',
    'scan.welcome_gift': '1 free scan available',
    'scan.topup_remaining': '{n} scan(s) available',
    'scan.get_more': 'Get more scans',
  ...
  pt: {
    ...
    'settings.delete_scan_history': 'Apagar Histórico de Análises',
    ...
    'consent.body': "Sua foto de rosto é um dado biométrico — por isso pedimos sua permissão antes de continuar.\n\n• A foto é enviada para análise por inteligência artificial (Google Gemini) apenas no momento do escaneamento.\n• Ela não é armazenada em nenhum servidor — é analisada e descartada imediatamente.\n• Só os resultados (notas de hidratação, oleosidade etc.) ficam salvos no seu perfil, para você acompanhar sua evolução.\n• Você pode apagar esse histórico ou revogar essa permissão a qualquer momento, em Configurações.\n\nEsta análise é gerada por IA e tem caráter informativo e de autocuidado — não substitui consulta, diagnóstico ou tratamento dermatológico profissional.",
    'consent.accept': 'Entendi e aceito',
    'consent.decline': 'Agora não',
    'consent.locked_message': 'Você recusou o consentimento para a análise facial por IA. Toque para revisar e aceitar.',
    ...
    'paywall.topup_plan': 'Pacote Avulso',
    'paywall.topup_badge': 'PAGAMENTO ÚNICO',
    'paywall.topup_desc': '+2 análises faciais · +3 explorações de ingredientes',
    'paywall.topup_btn': 'Comprar Pacote',
    'paywall.monthly_plan': 'Premium Mensal',
    'paywall.monthly_badge': 'MAIS POPULAR',
    'paywall.monthly_desc': 'Todas as funções ilimitadas por 30 dias',
    'paywall.monthly_btn': 'Assinar Premium',
    'paywall.monthly': '{price} / mês',
    'paywall.feat_unlimited': 'Rotinas e Produtos ilimitados',
    'paywall.feat_ai': 'Análise Facial IA — ilimitada',
    'paywall.feat_journal': 'Diário da pele e acompanhamento fotográfico',
    'paywall.feat_scan': 'Leitor Facial IA exclusivo',
    'paywall.trial': 'Assinar Premium',
    ...
    'paywall.purchase_topup_title': 'Pacote Ativado!',
    'paywall.purchase_topup_msg': 'Seus créditos foram adicionados. Boas análises!',
    ...
    'scan.limit_reached': 'Sem créditos disponíveis. Compre um pacote ou assine o Premium.',
    'scan.premium_only': 'Recurso Premium',
    'scan.remaining': 'Análises restantes este mês: {n}',
    'scan.welcome_gift': '1 análise gratuita disponível',
    'scan.topup_remaining': '{n} análise(s) disponíveis',
    'scan.get_more': 'Obter mais análises',
